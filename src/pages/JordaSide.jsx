...
const KAPITLER = [
  { id: 'geologi', navn: 'Geologi', farge: '#0e7060', ikon: '🌋' },
  { id: 'okologi', navn: 'Økologi', farge: '#1b7a3e', ikon: '🦋' },
  { id: 'celler-og-livets-utvikling', navn: 'Celler og livets utvikling', farge: '#5a7700', ikon: '🦠' },
];
