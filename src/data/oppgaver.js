...
export const oppgaver = {
  'klima-og-baerekraft': [
    ...
    },
    {
      ...
      fasit: [
        `En interessekonflikt oppstår når én interessegruppe sin bruk av en ressurs ødelegger for en annen interessegruppe sin bruk av den samme ressursen. Gruppene vil altså bruke det samme området, vannet eller naturgodet til ulike ting, og bruken kan ikke foregå side om side. I miljøsaker står hensynet til natur og dyreliv ofte mot økonomiske interesser, arbeidsplasser eller behovet for energi, og da må noen hensyn vike for andre.`,
        `Aralsjøen på grensa mellom Usbekistan og Kasakhstan er et tydelig eksempel. Sjøen var en gang verdens fjerde største innsjø og grunnlaget for en stor fiskerinæring. Så ble elvene som fylte sjøen, ledet bort for å vanne enorme bomullsplantasjer. Her ødela bomullsdyrkernes bruk av vannet for fiskerne og for dyrelivet, som trengte det samme vannet. Bomullen vant, og i løpet av noen få tiår tørket Aralsjøen nesten helt ut. Fiskeriene forsvant, og den tørrlagte sjøbunnen ligger igjen som en ørken av salt og sprøytemiddelrester som blåser opp i støvstormer og gir helseproblemer for folk i området.`,
        `Vindmøller på norske fjell er et eksempel nærmere oss. Utbyggerne og myndighetene vil bruke fjellet til å produsere fornybar energi, som gir strøm og lavere klimagassutslipp. Men de samme fjellområdene brukes til friluftsliv, turisme og reindrift, og de er leveområder for fugler og villrein. Vindmøller, anleggsveier og kraftlinjer gjør store inngrep i urørt natur, dyra skyr områdene, og fugler kan bli drept av rotorbladene. Her ødelegger altså kraftutbyggernes bruk av fjellet for dem som bruker det samme fjellet til friluftsliv, næring og som leveområde. Konflikten er spesiell fordi begge sider på hver sin måte vil ta vare på miljøet: den ene gjennom klimavennlig energi, den andre gjennom å bevare naturen slik den er.`,
        `Altaelva i Finnmark er et eksempel der samiske interesser sto sentralt. Staten ville demme opp Alta-Kautokeinovassdraget for å bygge kraftverk og produsere vannkraft. Men elva er en av landets beste lakseelver, og områdene rundt var viktige beiter og flytteveier for reinen til reindriftssamene. Kraftutbyggernes bruk av vassdraget ødela dermed for laksefisket, for naturvernet og for reindrifta, som var avhengige av det samme vassdraget. Rundt 1980 ble det store demonstrasjoner, folk lenket seg fast i Stilla, og samer sultestreiket foran Stortinget. Kraftverket ble bygd, men i mindre omfang enn planlagt, og samebygda Masi ble spart. Saken førte til at samiske rettigheter ble tatt mer på alvor, og var en viktig årsak til at Sametinget ble opprettet i 1989.`,
      ],
    },
    {
