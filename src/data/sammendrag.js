...
export const sammendrag = {
  'geologi': [
    ...
    },
    {
      ...
      bilde: `sammendrag/geologi/island.jpg`,
      bildeAlt: `Vulkanutbrudd på Island, 2023`,
      bildeTekst: `Island, 2023`,
      bildeKredit: `© Giles Laurent, gileslaurent.com, License CC BY-SA`,
    },
    {
      ...
      tekst: [
        ...
        { bilde: `sammendrag/geologi/pangaea.gif`, bildeAlt: `Animasjon av Pangea som brytes opp` },
    ...
    },
    {
      ...
      tekst: `I 1912 la den tyske forskeren Alfred Wegener frem teorien om at alle verdens kontinenter en gang hadde hengt sammen i ett stort superkontinent. Bevisene hans var overbevisende: kystlinjene på begge sider av Atlanterhavet passer nesten som puslespillbrikker, det er funnet fossiler av de samme dyr og planter på kontinenter som i dag ligger langt fra hverandre, og bergartene på begge sider av havene er de samme. Teorien ble likevel avvist av mange forskere fordi den ikke forklarte hvordan slik drift foregikk. I dag er kontinentaldriften godt dokumentert, og vi kan bruke satellitter til å måle selv bittesmå bevegelser i platene.`,
    },
    {
  ...
  'celler-og-livets-utvikling': [
    ...
    },
    {
      ...
      tekst: `Vi deler celler inn i to hovedtyper. Celler uten cellekjerne, slik som bakterier, har en tjukk cellevegg utenfor cellemembranen, cellevæske (cytoplasma) og fritt arvestoff inne i cella. Celler med cellekjerne, slik som dyreceller og planteceller, har en tynn cellemembran som hinne ytterst. Inne i cellevæska ligger små «organer» kalt organeller, og arvestoffet er samlet i en egen cellekjerne. Cellekjernen fungerer som kommandosentralen i cella.`,
    },
    {
    ...
    {
      tittel: `Arv og miljø`,
      tekst: `Hvordan en organisme blir og ser ut bestemmes både av arv og av miljø. Arvestoffet fra mor og far legger grunnlaget, men miljøet rundt oss påvirker også mye. Noen egenskaper bestemmes bare av arv, noen bare av miljø, og mange av en kombinasjon av begge deler.`,
    },
    {
    ...
    },
    {
      ...
      tekst: `Et gen har som oppgave å gi ribosomene oppskriften på hvilket protein de skal lage. DNA-molekylet er bygd opp av fire ulike baser, forkortet A, T, C og G, som står i ulik rekkefølge for ulike proteiner. Tre baser etter hverandre danner en triplettkode, og hver triplettkode gir én bestemt aminosyre. Proteiner er bygd opp av aminosyrer som er hektet sammen, og det er rekkefølgen på aminosyrene som avgjør hvilket protein som blir laget. Kjeden er altså: kromosom → DNA → gen → ATCG-basepar → triplettkode → aminosyre → protein.`,
    },
    {
    ...
    },
    {
      ...
      tekst: [
        ...
        { bilder: [`sammendrag/celler/finker2.jpeg`, `sammendrag/celler/evolusjon.png`], bilderAlt: [`Darwins finker`, `Evolusjon`] },
  ...
  'nerve-og-hormonsystemet': [
    ...
    {
      tittel: `Diabetes`,
      tekst: `Diabetes er en sykdom som henger sammen med hormonet insulin. Har en person for lite insulin, eller mangler det helt, klarer ikke kroppen å regulere blodsukkeret. Dette kalles diabetes type 1, og den er medfødt. Ved diabetes type 2 har kroppen blitt mindre følsom for sitt eget insulin, slik at insulinet får dårlig eller ingen effekt. Diabetes type 2 regnes som en livsstilssykdom.`,
    },
    {
  ...
  'okologi': [
    ...
    },
    {
      ...
      bilde: `sammendrag/okologi/vegetasjon-hd.png`,
      bildeBredd: `660px`,
    ...
    },
    {
      ...
      figur: `produsenter-forbrukere-nedbrytere`,
    },
    {
  ...
  'klima-og-baerekraft': [
    {
      ...
      tekst: `Menneskelig aktivitet påvirker naturen både lokalt og globalt. Bærekraftig utvikling betyr at vi skal utvikle samfunnet slik at vi dekker behovene våre i dag, uten å ødelegge mulighetene for at framtidige generasjoner skal dekke sine. Det handler om å få kontroll over miljøproblemene vi allerede har, hindre nye, og bruke ressursene våre uten å bruke dem opp.`,
    },
    {
    ...
    },
    {
      ...
      tekst: `Å forvalte naturen betyr å holde styr på naturressursene og bruke dem på best mulig måte, blant annet ved å planlegge hvordan arealer skal brukes. Det krever overvåking, forskning og lover som verner naturen. Et viktig prinsipp er føre-var-prinsippet: vi setter i gang tiltak for å begrense bruken av et stoff eller en ressurs før vi har sikker vitenskapelig bekreftelse på at det er skadelig. Tanken er at hvis vi venter til skaden er bevist, kan det allerede være for sent.`,
    },
    {
      tittel: `Internasjonalt samarbeid`,
      tekst: `Miljøproblemer kjenner ingen landegrenser, så landene må samarbeide. Et godt eksempel er forbudet mot KFK- og halongasser, som har gjort at ozonhullet nå er på vei til å lukke seg igjen. Det viser at internasjonale avtaler faktisk kan virke, og gir håp om at vi også kan løse klimaproblemene hvis vi samarbeider.`,
    },
    {
      tittel: `Interessekonflikter`,
      tekst: [
        `Ofte må vi veie ulike hensyn mot hverandre, og da oppstår interessekonflikter. Et isfritt Arktis kan åpne for skipsfart og olje, men er en katastrofe for naturen. Ved Altaelva sto utbygging av kraftverk mot å bevare laksen og samiske rettigheter. Slike saker viser at vern av natur og bruk av natur kan komme i konflikt, og at det sjelden finnes enkle svar.`,
        `Et annet eksempel er Aralsjøen, på grensa mellom Usbekistan og Kasakhstan. Aralsjøen var en gang verdens fjerde største innsjø, med et rikt dyreliv som var grunnlaget for en stor fiskerinæring og levebrød for menneskene som bodde rundt den. Men elvene som fylte sjøen, ble omdirigert til å vanne enorme bomullsplantasjer, og dermed kom interessene til bomullsdyrkerne i konflikt med interessene til menneskene og dyrelivet ved sjøen. Bomullen vant, og i løpet av noen få tiår tørket Aralsjøen nesten helt ut. Den tørrlagte sjøbunnen ligger nå igjen som en ørken full av salt og rester av sprøytemidler, som blåser opp i store støvstormer og gir helseproblemer for befolkningen i området. En liten del i nord er reddet etter at Kasakhstan bygde en demning i 2005, men det meste av innsjøen er fortsatt borte.`,
